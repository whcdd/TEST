...
u8 DXL_aTxBuffer[DXL_RXBUFFSIZE] = {0};
...
//		HAL_DMA_Start(&hdma_uart1_tx,(u32)USB2UART_aTxBuffer0,(u32)&huart4.Instance->TDR,USB2UART_RXBUFFSIZE);
...
DXL_StatusTypeDef DXL_SendData(u8 *databuf, u8 len)
{
	...
	UART_Transmit(huart1,databuf,len);
